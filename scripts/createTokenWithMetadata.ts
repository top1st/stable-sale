...
const endpoint = clusterApiUrl('mainnet-beta'); //Replace with your RPC Endpoint
const solanaConnection = new Connection(endpoint);
const userWallet = Keypair.fromSecretKey(bs58.decode(process.env.ADMIN_KEY));
...
const MY_TOKEN_METADATA: UploadMetadataInput = {
    name: "SCFG",
    symbol: "SCFG",
    description: "SCFG Token",
    image: "https://raw.githubusercontent.com/top1st/token-assets/main/png/scfg.png" //add public URL to image you'd like to use
}
